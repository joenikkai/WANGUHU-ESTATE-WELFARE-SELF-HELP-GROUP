...
const DashboardSidebar = () => {
  ...
  return (
    <>
      {/* Sidebar - Desktop */}
      <aside className={`fixed top-0 left-0 z-40 h-screen transition-all duration-300 bg-white dark:bg-[#1A2433] border-r border-[#E2E8F0] dark:border-[#2D3A4A] sm:translate-x-0 ${isSidebarOpen ? 'w-72' : 'w-20'} hidden sm:flex flex-col`}>
        ...
        <nav className="flex-1 px-4 space-y-1.5 overflow-y-auto custom-scrollbar">
          ...
          {/* My Info Section */}
          {isSidebarOpen && (
            <div className="mt-8 pt-8 border-t border-[#E2E8F0] dark:border-[#2D3A4A]">
              <div className="flex items-center justify-between px-2 mb-4">
                <span className="text-[10px] font-black text-[#5A6B7A] uppercase tracking-[0.2em]">Sensitive Data</span>
                <button 
              ...
              <div className="space-y-4 px-2">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col">
                    <span className="text-[9px] font-bold text-[#94A3B8] uppercase">National ID</span>
                    <span className="text-xs font-mono dark:text-[#E2E8F0]">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col">
                    <span className="text-[9px] font-bold text-[#94A3B8] uppercase">KRA PIN</span>
                    <span className="text-xs font-mono dark:text-[#E2E8F0]">
